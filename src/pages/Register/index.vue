  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <span class="error-msg">错误提示信息</span> -->
        <input v-model="password" name="password" v-validate="{required: true,regex: /\w{6,15}$/}" 
      ...
      <div class="content">
        ...
        <span class="error-msg">错误提示信息</span> -->
        <input v-model="password2" name="password2" v-validate="{required: true,is:(password)}" 
      ...
      <div class="controls">
        ...
        <input v-model="isCheck" name="isCheck" type="checkbox" v-validate="{agree:true}" 
